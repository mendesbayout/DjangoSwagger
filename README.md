...
Além de uma documentação o SwaggerUI provém interface a CRUD operations e também opera com o package openAPI para fornecer um endpoint(no caso, http://127.0.0.1:8000/swagger/?format=openapi) para trabalhos em front end como exemplo, . Esse projeto pode ser usado como template para infinitos tipos de RESTfull API's graças a flexibilidade do framework. 
